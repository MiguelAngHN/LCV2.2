...
<div class="container bg-light rounded" style="font-family: Comic Sans MS">
    ...
    <div class="row align-items-center my-5">
      <div class="col-sm-6 col-md-6 text-start">
        <img src="{{asset('/storage/imagenes/P3ExQwU7xjbbqLqWQIr8A3D8HZw8IAObWH6GNHMM.gif')}}" class="img-fluid rounded mision2 my-4"/>
      </div>
      <div class="col-sm-6">
        <p>
    ...
    <div class="row align-items-center m-5 p-4">
      ...
      <div class="col-sm-6">
        <img src="{{asset('/storage/imagenes/wrcJOtMmzQNnkuI7FsmWma15fuB2KEY8x74zAXOu.png')}}" class="img-fluid rounded mision1" />
      </div>
    </div>
  </div>
