...
<head>
    ...
    <title> Learn Cartoon / Actividad / Suma </title>
...
<body>
    ...
    <p class="DescripcionSuma"> Bienvenido, al juego de sumar números. En este juego te adentrarás en
        las matematicas con diversión y desafío. ➕💯<br><br>
        <b>Tu misión es simple:</b> escoje la opcion que creas correcta, escucha los audios de
        Instrucciones y los más importante diviertete, aprende como funciona la SUMA.<br>
    </p>

    <div class="MensajeInicio">
        <img src="{{asset('assets/images/LogoPos2.webp')}}" alt="Logo">
        <h2> Vamos a sumar juntos✨ </h2>
    </div>
...
<div>
    ...
    <script src="{{asset('assets/js/scriptSuma.js')}}"></script><BR>
    ...
    <div id="contenedorOculto">
        <div id="contenidoOculto" class="oculto">
            ...
            <h2 class="TituloOculto">Lo haces muy bien, ahora, más desafiante.</h2>
            <p class="DescripcionSuma"> En esta parte tendrás números con 2 cifras, así que sumaras
        ...
        <div>
            ...
            <script src="{{asset('assets/js/script2Suma.js')}}"></script><BR>
